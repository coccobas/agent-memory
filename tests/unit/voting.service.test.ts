...
import { recordVote, calculateConsensus, listVotes, getVotingStats } from '../../src/services/voting.service.js';
...
describe('voting.service', () => {
  ...
  describe('calculateConsensus', () => {
    ...
    it('should return dissenting votes', () => {
      recordVote({ taskId: 'task-dissent', agentId: 'agent-1', voteValue: 'option-a', confidence: 0.9 });
      recordVote({ taskId: 'task-dissent', agentId: 'agent-2', voteValue: 'option-b', confidence: 0.8 });
    ...
    it('should calculate confidence from consensus votes', () => {
      recordVote({ taskId: 'task-conf', agentId: 'agent-1', voteValue: 'option-a', confidence: 0.8 });
      recordVote({ taskId: 'task-conf', agentId: 'agent-2', voteValue: 'option-a', confidence: 0.9 });
