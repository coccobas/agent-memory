...
import {
  QueryExpander,
  RelationGraphTraverser,
} from '../../src/services/query-rewrite/expander.js';
...
describe('QueryExpander', () => {
  ...
  describe('expand - relation-based', () => {
    it('should use relation traverser when available', async () => {
      const traverser: RelationGraphTraverser = vi
        .fn()
        .mockResolvedValue([{ term: 'related-term', distance: 1 }]);
  ...
  describe('expand - combined strategies', () => {
    it('should combine dictionary and relation expansions', async () => {
      const traverser: RelationGraphTraverser = vi
        .fn()
        .mockResolvedValue([{ term: 'related', distance: 1 }]);
