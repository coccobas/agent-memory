...
export const SUMMARIZATION_TEST_CASES: SummarizationTestCase[] = [
  ...
  // ==========================================================================
  {
    ...
    sourceEntries: [
      {
        type: 'knowledge',
        content: 'The API layer has three sub-layers: controllers, services, and repositories.',
        category: 'architecture',
      },
      {
        type: 'knowledge',
        content: 'Controllers handle HTTP requests and responses.',
        category: 'architecture',
      },
      { type: 'knowledge', content: 'Services contain business logic.', category: 'architecture' },
      {
        type: 'knowledge',
        content: 'Repositories manage database access.',
        category: 'architecture',
      },
  ...
  },
  {
    ...
    sourceEntries: [
      {
        type: 'knowledge',
        content: 'Errors flow up from repositories to services to controllers.',
      },
      ...
      {
        type: 'guideline',
        content: 'Controllers catch BusinessError and return HTTP error responses.',
      },
  ...
  },
  {
    ...
    sourceEntries: [
      ...
      {
        type: 'knowledge',
        content: 'There is ongoing discussion about unifying naming conventions.',
      },
    ],
  ...
  // ==========================================================================
  {
    ...
    sourceEntries: [
      ...
      { type: 'guideline', content: 'Include ETag headers for caching.' },
      {
        type: 'tool',
        content:
          'Use curl for API testing: curl -H "Authorization: Bearer $TOKEN" https://api.example.com/v1/users',
      },
  ...
  // ==========================================================================
  {
    ...
    sourceEntries: [
      ...
      {
        type: 'knowledge',
        content: 'Actually, the deployment requires AWS credentials from DevOps.',
      },
  ...
  },
  {
    ...
    sourceEntries: [
      ...
      {
        type: 'knowledge',
        content: 'FIX: Increase pool to 500 and add connection timeout of 30s.',
      },
  ...
  },
  {
    ...
    sourceEntries: [
      ...
      {
        type: 'knowledge',
        content: 'CRITICAL: This query has no index and will cause full table scan on 10M rows.',
      },
      ...
      {
        type: 'knowledge',
        content: 'REQUIRED: Add composite index on (user_id, created_at) for this query.',
      },
