...
export const QUERY_SEED_DATA: SeedData = {
  ...
  entries: [
    ...
    },
    {
      ...
      content:
        'Security best practice: Always validate and sanitize user input to prevent injection attacks',
      category: 'security',
      priority: 95,
    ...
    },
    {
      ...
      content:
        'Security requirement: All API endpoints must require authentication except public health checks',
      category: 'security',
      priority: 90,
    ...
    // ==========================================================================
    {
      ...
      content:
        'We chose PostgreSQL for the primary database because of its reliability, ACID compliance, and excellent JSON support for flexible schemas',
      category: 'decision',
      confidence: 0.95,
    ...
    },
    {
      ...
      content:
        'Redis is used for caching frequently accessed data and session storage to reduce database load',
      category: 'decision',
      confidence: 0.9,
    ...
    },
    {
      ...
      content:
        'The API follows REST principles with JSON payloads. We chose REST over GraphQL for simplicity and caching benefits.',
      category: 'decision',
      confidence: 0.9,
    ...
    },
    {
      ...
      content:
        'JWT tokens are used for stateless authentication. Access tokens expire in 15 minutes, refresh tokens in 7 days.',
      category: 'decision',
      confidence: 0.95,
    ...
    },
    {
      ...
      content:
        'Production runs on AWS ECS with Fargate. Staging uses the same configuration with smaller instance sizes.',
      category: 'fact',
      confidence: 0.95,
    ...
    },
    {
      ...
      content:
        'The backend team consists of 5 engineers. Alice leads architecture, Bob handles DevOps.',
      category: 'fact',
      confidence: 0.8,
    ...
    },
    {
      ...
      content:
        'API versions are included in the URL path: /api/v1/, /api/v2/. Major versions are supported for 2 years.',
      category: 'fact',
      confidence: 0.9,
      tags: ['api', 'versioning'],
    },
    ...
    },
    {
      ...
      content:
        'The new dashboard feature is behind feature flag BETA_DASHBOARD. Available to 10% of users.',
      category: 'context',
      confidence: 0.9,
      validFrom: '2025-01-01T00:00:00Z',
    ...
    // Low confidence knowledge (for confidence filtering tests)
    {
      ...
      content:
        'The API timeout might be 30 seconds, but this needs verification with the infrastructure team',
      category: 'context',
      confidence: 0.5,
    ...
    // Entry with special characters (for special char search tests)
    {
      ...
      content:
        'When working with C++ or C#, use appropriate naming conventions: snake_case for C++, PascalCase for C#',
      category: 'fact',
      confidence: 0.9,
    ...
    // Multi-hop relation target (for deep relation traversal)
    {
      ...
      content:
        'This guideline is connected through a chain of relations for testing multi-hop traversal',
      category: 'architecture',
      priority: 70,
    ...
    // Entry for fuzzy search (authentication-related for typo tests)
    {
      ...
      content:
        'The authentication flow uses OAuth2 with PKCE for mobile apps and standard code flow for web',
      category: 'fact',
      confidence: 0.95,
    ...
    // Entry for regex/version tests
    {
      ...
      content:
        'v1 was released in 2023, v2 in 2024, and v3 is planned for 2025. Each version maintains backwards compatibility.',
      category: 'fact',
      confidence: 1.0,
    ...
    // OVERLAPPING CONTENT: Same topic, different words (for synonym-gaps tests)
    {
      ...
      content:
        'We use Postgres as our primary relational data store. It handles OLTP workloads well.',
      category: 'decision',
      confidence: 0.95,
      tags: [
        'database',
    ...
    },
    {
      ...
      content:
        'Application state is persisted to a SQL database cluster with replication. We chose PostgreSQL.',
      category: 'decision',
      confidence: 0.9,
      tags: [
        'persistence',
    ...
    },
    {
      ...
      content:
        'The storage tier uses a relational database management system. PG handles primary writes.',
      category: 'fact',
      confidence: 0.85,
      tags: [
        'storage',
    ...
    // OVERLAPPING CONTENT: Authentication/security variants
    {
      ...
      title: 'Login Process',
      content:
        'Users authenticate via username/password or SSO. After successful auth, a session token is issued.',
      category: 'fact',
      confidence: 0.9,
      tags: [
        'login',
    ...
    },
    {
      ...
      content:
        'RBAC is implemented for authorization. Permissions are checked after user identity is verified.',
      category: 'decision',
      confidence: 0.95,
      tags: [
        'rbac',
    ...
    // OVERLAPPING CONTENT: Testing variants
    {
      ...
      content:
        'We use a pyramid: many unit tests, fewer integration tests, minimal E2E. Vitest for unit, Playwright for E2E.',
      category: 'decision',
      confidence: 0.9,
      tags: [
        'testing',
    ...
    },
    {
      ...
      name: 'test-isolation',
      content:
        'Tests must be isolated and not depend on external state. Use mocks for external services.',
      category: 'testing',
      priority: 85,
      tags: [
        'testing',
    ...
    // OVERLAPPING CONTENT: Deployment/infrastructure variants
    {
      ...
      content:
        'Production is deployed to AWS. We use ECS Fargate for container orchestration without managing servers.',
      category: 'fact',
      confidence: 0.95,
      tags: [
        'cloud',
    ...
    // OVERLAPPING CONTENT: API design variants
    {
      ...
      content:
        'REST endpoints follow resource-based naming. Use nouns for resources, HTTP verbs for actions.',
      category: 'decision',
      confidence: 0.95,
      tags: [
        'api',
    ...
    },
    {
      ...
      content:
        'All API responses use JSON. Include status, data, and optional error fields in response body.',
      category: 'code_style',
      priority: 85,
      tags: [
        'api',
    ...
    },
    {
      ...
      content:
        'We use a hierarchical error code system: E1xxx for validation, E2xxx for auth, E3xxx for database.',
      category: 'fact',
      confidence: 0.95,
      tags: [
        'errors',
    ...
    },
    {
      ...
      content:
        'API error responses must include error code, message, and optional details. Use appropriate HTTP status.',
      category: 'code_style',
      priority: 85,
      tags: [
        'errors',
    ...
    },
    {
      ...
      description:
        'Sentry captures and tracks production errors. Check dashboard at sentry.io/project/',
      category: 'cli',
      tags: [
        'errors',
        'sentry',
    ...
    // MORE OVERLAPPING: Performance/caching variants
    {
      ...
      content:
        'Redis serves as our distributed cache. TTL is 5 minutes for most entities, 1 hour for static config.',
      category: 'decision',
      confidence: 0.9,
      tags: [
        'caching',
    ...
    },
    {
      ...
      content:
        'P95 latency must be under 200ms for API calls. Database queries should complete in under 50ms.',
      category: 'fact',
      confidence: 1.0,
      tags: [
        'performance',
    ...
    // MORE OVERLAPPING: Logging/monitoring variants
    {
      ...
      content:
        'Structured JSON logs are sent to CloudWatch. We use Pino for logging in Node.js services.',
      category: 'fact',
      confidence: 0.95,
      tags: [
        'logging',
    ...
    },
    {
      ...
      content:
        'Use DEBUG for development, INFO for operations, WARN for recoverable issues, ERROR for failures.',
      category: 'code_style',
      priority: 75,
      tags: [
        'logging',
    ...
    },
    {
      ...
      description:
        'View logs in CloudWatch console or use: aws logs tail /ecs/service-name --follow',
      category: 'cli',
      tags: [
        'logging',
        'cloudwatch',
    ...
    // MORE OVERLAPPING: Code quality variants
    {
      ...
      content:
        'All PRs require at least one approval. Reviews should check logic, tests, and security.',
      category: 'workflow',
      priority: 90,
      tags: [
        'code-review',
    ...
    },
    {
      ...
      content:
        'Coding standards are documented in CONTRIBUTING.md. Style guide follows Airbnb conventions.',
      category: 'fact',
      confidence: 0.9,
      tags: [
        'standards',
    ...
    // ADDITIONAL ENTRIES: Various topics for diversity
    {
      ...
      content:
        'SQS handles async job processing. Dead letter queues capture failed messages after 3 retries.',
      category: 'decision',
      confidence: 0.9,
      tags: [
        'queue',
    ...
    },
    {
      ...
      content:
        'User uploads go to S3. Pre-signed URLs are used for secure downloads. Max file size is 10MB.',
      category: 'fact',
      confidence: 0.95,
      tags: [
        'files',
    ...
    },
    {
      ...
      content:
        'Use environment variables for all configuration. Never hardcode values that differ between environments.',
      category: 'code_style',
      priority: 95,
      tags: [
        'environment',
    ...
    },
    {
      ...
      name: 'npm-audit',
      description:
        'Check for vulnerable dependencies: npm audit. Fix with npm audit fix when safe.',
      category: 'cli',
      tags: [
        'security',
        'dependencies',
    ...
    // MORE ENTRIES: Internationalization/localization
    {
      ...
      content:
        'We use i18next for translations. Locale files are in /locales/{lang}/. Default language is English.',
      category: 'fact',
      confidence: 0.9,
      tags: [
        'i18n',
    ...
    },
    {
      ...
      content:
        'Never hardcode user-facing strings. All text must go through the translation system.',
      category: 'code_style',
      priority: 80,
      tags: [
        'i18n',
    ...
    // MORE ENTRIES: Accessibility
    {
      ...
      content:
        'All UI must meet WCAG 2.1 AA standards. Use semantic HTML and proper ARIA attributes.',
      category: 'code_style',
      priority: 85,
      tags: [
        'accessibility',
    ...
    },
    {
      ...
      content:
        'We use axe-core for automated a11y testing. Manual testing with screen readers is done before major releases.',
      category: 'fact',
      confidence: 0.85,
      tags: [
        'accessibility',
    ...
    // MORE ENTRIES: Feature flags
    {
      ...
      content:
        'LaunchDarkly manages feature flags. Flags can target by user ID, org, or percentage rollout.',
      category: 'decision',
      confidence: 0.9,
      tags: [
        'feature-flags',
    ...
    },
    {
      ...
      content:
        'Remove feature flags within 30 days of 100% rollout. Track flags in a cleanup spreadsheet.',
      category: 'workflow',
      priority: 70,
      tags: [
        'feature-flags',
    ...
    // MORE ENTRIES: Search functionality
    {
      ...
      content:
        'Elasticsearch powers full-text search. Index updates are near-real-time via change data capture.',
      category: 'decision',
      confidence: 0.95,
      tags: [
        'search',
    ...
    },
    {
      ...
      content:
        'Index schema changes require migration plan. Test reindexing on staging before production.',
      category: 'workflow',
      priority: 80,
      tags: [
        'search',
    ...
    // MORE ENTRIES: Email/notifications
    {
      ...
      title: 'Email Service',
      content:
        'SendGrid handles transactional emails. Templates are stored in SendGrid and referenced by ID.',
      category: 'fact',
      confidence: 0.9,
      tags: [
        'email',
    ...
    },
    {
      ...
      content:
        'Test emails in staging before production. Use Mailhog locally to capture outgoing mail.',
      category: 'testing',
      priority: 75,
      tags: [
        'email',
    ...
    // MORE ENTRIES: Backup/recovery
    {
      ...
      content:
        'Daily snapshots to S3 with 30-day retention. Point-in-time recovery enabled for PostgreSQL.',
      category: 'fact',
      confidence: 1.0,
      tags: [
        'backup',
    ...
    },
    {
      ...
      content:
        'Test backup restoration quarterly. Document recovery time and verify data integrity.',
      category: 'workflow',
      priority: 85,
      tags: [
        'backup',
    ...
    },
    {
      ...
      description:
        'Restore PostgreSQL backup: pg_restore -d dbname backup.dump --clean --if-exists',
      category: 'cli',
      tags: [
        'backup',
        'restore',
    ...
    // MORE ENTRIES: Monitoring/alerting
    {
      ...
      content:
        'Prometheus collects metrics, Grafana for dashboards. AlertManager handles notifications.',
      category: 'fact',
      confidence: 0.95,
      tags: [
        'monitoring',
    ...
    },
    {
      ...
      content:
        'Alerts must be actionable. Include runbook links in alert descriptions. Avoid alert fatigue.',
      category: 'workflow',
      priority: 80,
      tags: [
        'alerting',
    ...
    // MORE ENTRIES: API rate limiting
    {
      ...
      content:
        'API rate limits: 100 req/min per user, 1000 req/min per org. Limits are enforced at the gateway.',
      category: 'fact',
      confidence: 1.0,
      tags: [
        'rate-limiting',
    ...
    },
    {
      ...
      content:
        'Return 429 Too Many Requests with Retry-After header. Client should implement exponential backoff.',
      category: 'code_style',
      priority: 85,
      tags: [
        'rate-limiting',
    ...
    // MORE ENTRIES: GraphQL (alternative to REST)
    {
      ...
      content:
        'Mobile apps use GraphQL for efficiency. REST remains primary for web and third-party integrations.',
      category: 'decision',
      confidence: 0.85,
      tags: [
        'graphql',
    ...
    },
    {
      ...
      content:
        'Limit query depth to 5 levels. Implement query cost analysis to prevent DoS attacks.',
      category: 'security',
      priority: 90,
      tags: [
        'graphql',
    ...
    // MORE ENTRIES: Microservices
    {
      ...
      content:
        'System is split into user-service, order-service, payment-service, and notification-service.',
      category: 'fact',
      confidence: 0.95,
      tags: [
        'microservices',
    ...
    },
    {
      ...
      content:
        'Services communicate via HTTP/gRPC for sync calls, SQS for async. Never share databases.',
      category: 'architecture',
      priority: 95,
      tags: [
        'microservices',
    ...
    // MORE ENTRIES: Secrets management
    {
      ...
      content:
        'AWS Secrets Manager stores all secrets. Applications fetch secrets at startup, not via env vars.',
      category: 'decision',
      confidence: 0.95,
      tags: [
        'secrets',
    ...
    },
    {
      ...
      content:
        'Rotate secrets every 90 days. Database passwords rotate automatically via Secrets Manager.',
      category: 'security',
      priority: 95,
      tags: [
        'secrets',
    ...
    // MORE ENTRIES: Database migrations
    {
      ...
      content:
        'Drizzle ORM generates migrations. Migrations run automatically on deployment. Backward compatible only.',
      category: 'decision',
      confidence: 0.9,
      tags: [
        'migrations',
    ...
    },
    {
      ...
      content:
        'Test migrations on a copy of production data. Verify rollback works before deploying.',
      category: 'workflow',
      priority: 90,
      tags: [
        'migrations',
    ...
    // MORE ENTRIES: Frontend architecture
    {
      ...
      content:
        'React 18 with TypeScript. Vite for bundling. TailwindCSS for styling. React Query for data fetching.',
      category: 'fact',
      confidence: 0.95,
      tags: [
        'frontend',
    ...
    },
    {
      ...
      content:
        'Use React Query for server state. Zustand for client-only state. Avoid Redux complexity.',
      category: 'code_style',
      priority: 80,
      tags: [
        'frontend',
    ...
    // MORE ENTRIES: Git workflow
    {
      ...
      content:
        'We use trunk-based development. Feature branches are short-lived. Main is always deployable.',
      category: 'decision',
      confidence: 0.95,
      tags: [
        'git',
    ...
    },
    {
      ...
      content:
        'Use conventional commits: feat:, fix:, docs:, chore:. Include ticket number in commit.',
      category: 'workflow',
      priority: 75,
      tags: [
        'git',
    ...
    // MORE ENTRIES: CI/CD pipeline
    {
      ...
      title: 'CI Pipeline',
      content:
        'GitHub Actions runs CI. Jobs: lint, typecheck, test, build. All must pass for merge.',
      category: 'fact',
      confidence: 1.0,
      tags: [
        'ci',
    ...
    // MORE ENTRIES: On-call/incidents
    {
      ...
      content:
        'Weekly rotation via PagerDuty. Primary and secondary on-call. Handoff is Monday 9am.',
      category: 'fact',
      confidence: 0.9,
      tags: [
        'oncall',
    ...
    },
    {
      ...
      content:
        'Acknowledge alerts within 15 min. Create incident channel in Slack. Write postmortem within 48h.',
      category: 'workflow',
      priority: 95,
      tags: [
        'incidents',
    ...
    },
    {
      ...
      description:
        'SSH into production container: aws ecs execute-command --cluster prod --task $TASK_ID',
      category: 'cli',
      tags: [
        'debugging',
        'production',
    ...
    // ADDITIONAL ORG-LEVEL ENTRIES
    {
      ...
      content:
        'Security review required for all new integrations, auth changes, and data handling modifications.',
      category: 'security',
      priority: 100,
      tags: [
        'security',
    ...
    },
    {
      ...
      content:
        'All personal data must be encrypted at rest and in transit. GDPR compliance is mandatory.',
      category: 'security',
      priority: 100,
      tags: [
        'privacy',
    ...
    },
    {
      ...
      content:
        'Tech radar is updated quarterly. Check before adopting new libraries or frameworks.',
      category: 'decision',
      confidence: 0.9,
      tags: [
        'tech-radar',
  ...
  relations: [
    ...
    {
      sourceId: 'k-data-persistence',
      targetId: 'k-storage-architecture',
      relationType: 'related_to',
    },
    {
      sourceId: 'k-storage-architecture',
      targetId: 'k-backup-strategy',
    ...
    {
      sourceId: 'k-cloud-deployment',
      targetId: 'k-container-strategy',
      relationType: 'related_to',
    },
    ...
    {
      sourceId: 'g-input-validation',
      targetId: 'g-org-security-review',
      relationType: 'depends_on',
    },
    ...
    {
      sourceId: 'k-migration-strategy',
      targetId: 'g-migration-testing',
      relationType: 'related_to',
    },
    ...
    {
      sourceId: 'k-service-architecture',
      targetId: 'g-service-communication',
      relationType: 'applies_to',
    },
    { sourceId: 'k-rate-limiting', targetId: 'g-rate-limit-handling', relationType: 'applies_to' },
    {
      sourceId: 'g-global-documentation',
      targetId: 'k-api-docs-location',
      relationType: 'related_to',
    },
...
export const QUERY_TEST_CASES: QueryTestCase[] = [
  ...
  },
  {
    ...
    expectedResults: [{ seedEntryId: 'k-postgres-decision', relevanceGrade: 3 }],
    difficulty: 'easy',
  },
  {
    id: 'ke-003',
  ...
  // ===========================================================================
  {
    ...
    expectedResults: [{ seedEntryId: 'g-typescript-strict', relevanceGrade: 3 }],
    difficulty: 'easy',
  },
  {
    id: 'km-002',
  ...
  // ===========================================================================
  {
    ...
    expectedResults: [{ seedEntryId: 'g-auth-required', relevanceGrade: 3 }],
  ...
  },
  {
    ...
    expectedResults: [{ seedEntryId: 'g-solid-principles', relevanceGrade: 2 }],
  ...
  // ===========================================================================
  {
    ...
    expectedResults: [{ seedEntryId: 'g-no-secrets', relevanceGrade: 3 }],
    difficulty: 'easy',
  ...
  },
  {
    ...
    expectedResults: [{ seedEntryId: 'g-solid-principles', relevanceGrade: 3 }],
    difficulty: 'easy',
  ...
  },
  {
    ...
    expectedResults: [{ seedEntryId: 'g-max-line-length', relevanceGrade: 2 }],
  ...
  // ===========================================================================
  {
    ...
    difficulty: 'easy',
    notes:
      'Context action should return mix of types - limit increased to ensure all types included',
  },
  ...
  },
  {
    ...
    expectedResults: [{ seedEntryId: 't-npm-test', relevanceGrade: 3 }],
    difficulty: 'hard',
  },
  ...
  },
  {
    ...
    expectedResults: [{ seedEntryId: 'g-input-validation', relevanceGrade: 3 }],
    difficulty: 'medium',
  ...
  },
  {
    ...
    expectedResults: [{ seedEntryId: 't-db-migrate', relevanceGrade: 3 }],
    difficulty: 'medium',
  ...
  },
  {
    ...
    expectedResults: [{ seedEntryId: 'k-uncertain-timeout', relevanceGrade: 3 }],
    shouldNotReturn: ['k-postgres-decision'],
    difficulty: 'medium',
  },
  ...
  // ===========================================================================
  {
    ...
    expectedResults: [{ seedEntryId: 'k-maintenance-window', relevanceGrade: 3 }],
    difficulty: 'hard',
  ...
  },
  {
    ...
    expectedResults: [{ seedEntryId: 'k-feature-flag-beta', relevanceGrade: 3 }],
    difficulty: 'hard',
  },
  ...
  },
  {
    ...
    expectedResults: [{ seedEntryId: 'g-inactive-rule', relevanceGrade: 3 }],
    difficulty: 'easy',
  },
