...
```json
{"action": "search", "search": "<feature-name>", "types": ["guidelines", "knowledge"], "scope": {"type": "project", "inherit": true}}
```
...
```json
{"action": "search", "search": "<content>", "semanticSearch": true, "semanticThreshold": 0.90}
```
