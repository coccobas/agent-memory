 ...
 *
 * @param permissionService - The permission service instance
...
export function requirePermission(
  ...
  const hasPermission = permissionService.check(
    agentId,
    action,
    entryType ?? 'tool',
    null,
...
export function checkPermissionForFilter(
  ...
  return permissionService.check(agentId, action, entryType, entryId, scopeType, scopeId);
}
