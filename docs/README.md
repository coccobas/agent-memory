...
- [Hooks](guides/hooks.md) — Runtime enforcement via pre/post tool checks
...
- [Semantic Search](guides/semantic-search.md) — Vector search setup

### Operations

- [Performance](guides/performance.md) — Tuning and optimization
